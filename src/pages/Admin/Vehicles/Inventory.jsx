        ...
        return createPortal(
            <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
                ...
                <motion.div 
                    ...
                    className="relative bg-white w-full max-w-2xl rounded-[40px] shadow-2xl overflow-hidden z-10"
                >
    ...
    return (
        <CityLayout>
            ...
            <div className="p-4 space-y-6 text-left relative">
                {/* --- HEADER --- */}
                <header className="flex justify-between items-center bg-white p-6 rounded-[35px] border border-slate-100 shadow-sm relative z-10">
                    <div>
                    ...
                    <button 
                        ...
                        className="bg-[#10b981] hover:bg-[#059669] text-white px-6 py-3 rounded-2xl font-black text-[11px] uppercase tracking-widest flex items-center gap-2 shadow-lg transition-all active:scale-95 cursor-pointer relative z-20"
                    >
